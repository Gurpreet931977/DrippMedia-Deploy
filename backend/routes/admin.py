...
Password-protected with HTTP Basic Auth via query param or session cookie.
"""
...
ADMIN_PASSWORD = os.getenv("ADMIN_PASSWORD", "dripp2026")
...
def admin_login():
    if request.method == "POST":
        ...
        if pw == ADMIN_PASSWORD:
            ...
            resp.set_cookie(COOKIE_NAME, ADMIN_PASSWORD, httponly=True, max_age=60*60*8)
            return resp
